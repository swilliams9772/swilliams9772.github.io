    ...
    variants: {
      variant: {
        default: cn(
          ...
          "from-background/50 to-background/80 bg-gradient-to-b"
        ),
        success: cn(
          "border-success/50 bg-success/10 text-success",
          "from-success/5 to-success/10 bg-gradient-to-b"
        ),
        destructive: cn(
          "destructive group border-destructive/50 bg-destructive/10 text-destructive",
          "from-destructive/5 to-destructive/10 bg-gradient-to-b"
        ),
        info: cn(
          "border-primary/50 bg-primary/10 text-primary",
          "from-primary/5 to-primary/10 bg-gradient-to-b"
        ),
      },
    },
    defaultVariants: {
