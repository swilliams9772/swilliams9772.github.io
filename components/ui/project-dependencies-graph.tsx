...
interface Node {
  id: string;
  label: string;
  type: 'project' | 'dependency' | 'technology';
...
interface ProjectDependenciesGraphProps {
  ...
  useEffect(() => {
    ...
    const simulation = d3.forceSimulation(data.nodes as d3.SimulationNodeDatum[])
      .force("link", d3.forceLink(data.links)
        .id((d: any) => d.id)
        .distance(d => (d as Link).strength * 100)
    ...
    nodes.append("circle")
      .attr("r", d => d.size)
      .attr("fill", d => nodeColors[d.type][d.status])
